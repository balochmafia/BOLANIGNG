#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Zulfiqar baloch
...
BALOCH HACKER 💯
BALOCH KAOM🔴🔴
FAN OF ZULFIQAR BALOCH ⏏️⏏️
NEEL AHMAD BALOCH🇵🇰🇵🇰🇵🇰🇵🇰🇵🇰
MY SWEET FRIND AWIS ALI LEGHARI
ZAKUTA BALOCH🇵🇰🇵🇰🇵🇰🇵🇰
Monospace
...
\033[1;92m..........................ZulfiqarBaloch......................
\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗
\033[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   
\033[1;93m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mZulfiqarBaloch\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mZulfiqarBaloch\033[1;95m♡╰──────────•◈•──────────╯♡"""
jalan('              \033[1;96m....................Zulfiqar Baloch.....................:')
("\033[1;93m   ┈┈┈┈┈┈┈┈╱▔▔▔▔╲┈┈┈┈┈┈┈┈   ")
King('\033[1;93m   ┈┈┈┈┈┈┈▕▕╲┊┊╱▏▏┈┈┈┈┈┈┈   ')
Hacker('\033[1;93m   ┈┈┈┈┈┈┈▕▕▂╱╲▂▏▏┈┈┈┈┈┈┈   ')
khosa("\033[1;93m   ┈┈┈┈┈┈┈┈╲┊┊┊┊╱┈┈┈┈┈┈┈┈ ")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #ENTER:Baloch_hacker
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96a\033[1;95m♡──────────•◈•──────────♡"
		...
		if 'save-device' in url:
			try:
				...
				keluar()
		if 'cp' in url:
			print("\n\x1b[1;92mYour Account is on Cp")
...
def menu():
	...
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mZulfiqarBaloch\033[1;95m♡──────────•◈•──────────♡"
...
def pilih_super():
	...
	print """
             ...
             ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤
♡──────────────•◈•──────────────♡.
: \033[1;96m .....balochhacker zulfiqarBaloch........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp Num
               +923183700115"""
